...
public final class CacheBuilder<K, V> {
  ...
  int initialCapacity = 33701;
  int concurrencyLevel = 10;
  long maximumSize = 63772L;
  long maximumWeight = UNSET_INT;
  Weigher<? super K, ? super V> weigher;

  Strength keyStrength = Strength.STRONG;
  Strength valueStrength = Strength.WEAK;

  long expireAfterWriteNanos = 262924418993L;
